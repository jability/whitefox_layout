...
const uint16_t keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     * |---------------------------------------------------------------|
     * | Fn |Alt |Gui |        SpaceFn       |Caps |ADV |  |Lef|Dow|Rig|
     * `---------------------------------------------------------------'
     */
    [L_MAIN] = KEYMAP( \
    ...
    [L_FCT] = KEYMAP( \
            ...
            ______,    ______,    ______,    ______,    ______,   KC_HOME,   KC_LEFT,   KC_DOWN,     KC_UP,  KC_RIGHT,    KC_END,    ______,    ______,               ______,    ______, \
       TD(KC_BCBO),    ______,    ______,    ______,    ______,    ______,    ______,    ______,    ______,    ______,    ______,    ______,          TD(KC_BCBC),    ______,    ______, \
